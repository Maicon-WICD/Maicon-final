...
class Recorder():
    ...
    def __init__(self,
        ...
        self.weight_path = os.path.join(record_dir, 'last.pt')
    ...
    def save_weight(self, epoch: int, val_miou)-> None:
        """Weight 저장
            amp 추가
        Args:
        ...
        if val_miou > self.best_val_miou:
            ...
            torch.save(check_point, os.path.join(self.record_dir, 'model.pt'))
            print("---------- best model is update ----------")
